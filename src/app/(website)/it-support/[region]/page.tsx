    ...
    return (
        <>
            ...
            <section className="relative py-16 lg:py-24 bg-gradient-to-br from-background via-background to-surface overflow-hidden">
                <div className="absolute inset-0 opacity-10"><Image src="/images/hero_it_network_1768423176860.png" alt="IT-Support und Netzwerk-Infrastruktur fuer Schweizer KMU" fill className="object-cover" priority aria-hidden="true" /></div>
            ...
            <section className="py-12 lg:py-16 bg-background">
                <div className="container mx-auto px-4"><AnimatedSection animation="slideUp">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="p-6 rounded-2xl bg-primary/5 border border-primary"><h3 className="text-lg font-bold text-text-primary mb-4">In Zahlen</h3><div className="grid grid-cols-2 gap-4">{data.stats.map((s, i) => <div key={i} className="text-center"><div className="text-2xl font-bold text-primary">{s.value}</div><div className="text-sm text-text-secondary">{s.label}</div></div>)}</div></div>
                    </div>
                </AnimatedSection></div>
            </section>
