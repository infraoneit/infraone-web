...
import { blogPosts, getBlogPostBySlug, generateBlogMetadata } from '@/data/blogPosts';
                    ...
                    <div className="relative aspect-[21/9] rounded-2xl overflow-hidden bg-gradient-to-br from-primary/20 to-primary/5 border border-border">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-text-secondary text-sm">Bild-Platzhalter</p>
                            ...
                            ">
                                ...
                                {post.content.split('\n').map((line, index) => {
                                    ...
                                    if (trimmedLine.startsWith('**') && trimmedLine.endsWith('**')) {
                                        return <p key={index} className="font-semibold text-text-primary">{trimmedLine.replace(/\*\*/g, '')}</p>;
                                    }
