...
const faqs = [
    ...
    { question: 'Was kostet der IT-Support?', answer: 'Remote-Support: CHF 120.–/h. Vor-Ort-Support: CHF 157.–/h. Im Raum Winterthur keine Anfahrtskosten, in anderen Regionen faire Pauschalen.' },
        ...
        <>
                        ...
                        <AnimatedSection animation="slideUp">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="p-6 rounded-2xl bg-card border border-border">
                                    <h3 className="font-bold text-text-primary mb-4">Vorteile {regionSlug ? `in ${content.headline.replace('IT-Support ', '')}` : ''}</h3>
            ...
            <section className="py-16 lg:py-24 bg-surface">
                <div className="container mx-auto px-4">
                    ...
                    <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto" staggerDelay={0.1}>
            ...
            <section className="py-16 lg:py-24 bg-background">
                <div className="container mx-auto px-4">
                    <AnimatedSection animation="slideUp" className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">IT-Support Preise</h2>
                        <p className="text-text-secondary">Transparent und fair – keine versteckten Kosten</p>
                    </AnimatedSection>
                    ...
                    <div className="max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <motion.div whileHover={{ y: -5 }} className="p-6 rounded-2xl bg-card border border-border text-center">
                            ...
                            <p className="text-3xl font-bold text-primary">CHF 120.–/h</p>
                        ...
                        <motion.div whileHover={{ y: -5 }} className="p-6 rounded-2xl bg-primary/5 border border-primary text-center">
                            ...
                            <p className="text-3xl font-bold text-primary">CHF 157.–/h</p>
                            <p className="text-sm text-text-secondary mt-2">Persönlich bei Ihnen</p>
                            {regionSlug && <p className="text-xs text-primary mt-1">+ {content.anfahrt}</p>}
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 lg:py-16 bg-background">
                <div className="container mx-auto px-4">
                    <h3 className="text-center text-lg font-bold text-text-primary mb-6">IT-Support in weiteren Regionen</h3>
                    <div className="flex flex-wrap justify-center gap-3">
                        {regions.map((r, index) => (
                            <Link key={index} href={r.href} className="px-4 py-2 rounded-lg bg-card border border-border hover:border-primary hover:text-primary transition-colors text-sm font-medium text-text-secondary">
                                {r.name}
                            </Link>
                        ))}
                    </div>
